...
public class KafkaConsumerConfig {
    ...
    public DefaultErrorHandler errorHandler(KafkaTemplate<String, Object> kafkaTemplate,
        ...
        var errorHandler = new DefaultErrorHandler(new DeadLetterPublishingRecoverer(kafkaTemplate), expBackOffRetries);
    ...
    public ExponentialBackOffWithMaxRetries expBackOffRetries() {
        var backOff = new ExponentialBackOffWithMaxRetries(property.backoff().maxRetries());
