...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ProjectCreateEvent> kafkaProjectCreateListenerContainerFactory(
            KafkaProperties kafkaProperties) {
        ConsumerFactory<String, ProjectCreateEvent> kafkaProjectCreateConsumerFactory = getProjectCreateConsumerFactory(kafkaProperties);
    ...
    private ConsumerFactory<String, ProjectCreateEvent> getProjectCreateConsumerFactory(KafkaProperties kafkaProperties) {
